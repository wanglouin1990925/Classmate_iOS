...
//
//            weakself.inputContainerView.frame.size.height = 16 + height
//            weakself.inputContainerView.frame.origin.y = weakself.view.bounds.height - weakself.keyboardHeight - weakself.inputContainerView.bounds.height
//            weakself.tableView.frame.size.height = weakself.view.bounds.height - 64 - weakself.keyboardHeight - weakself.inputContainerView.bounds.height
...
//                self.inputContainerView.frame.origin.y = self.view.bounds.height - self.inputContainerView.bounds.height
//                self.tableView.frame.size.height = self.view.bounds.height - 64 - self.keyboardHeight - self.inputContainerView.bounds.height
...
//                self.inputContainerView.frame.origin.y = self.view.bounds.height - keyboardHeight - self.inputContainerView.bounds.height
//                self.tableView.frame.size.height = self.view.bounds.height - 64 - self.keyboardHeight - self.inputContainerView.bounds.height
